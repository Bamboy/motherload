...
namespace Borodar.RainbowFolders.Editor
{
    public static class RainbowFoldersContextMenu
    {
        ...
        private const string BACKGROUND_CRISMON = MENU_BACKGROUND + "Crismon";
        ...
        [MenuItem(COLOR_CRISMON, false, ICONS_PRIORITY + 200)]
        ...
        [MenuItem(TAG_CRISMON, false, ICONS_PRIORITY + 200)]
        ...
        [MenuItem(BACKGROUND_CRISMON, false, BACKGROUND_PRIORITY + 200)]
        public static void BackgroundCrismon() { AssignBackground(FolderColorName.Crismon); }
