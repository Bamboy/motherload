...
namespace Borodar.RainbowFolders.Editor
{
    public static class RainbowFoldersIconsMenu
    {
        ...
        private static readonly GUIContent COLOR_CRISMON = new GUIContent(MENU_COLORIZE + "Crismon");
        ...
        private static readonly GUIContent TAG_CRISMON = new GUIContent(MENU_TAG + "Crismon");
        ...
        private static void CrismonCallback(object folder)
        { Colorize(FolderColorName.Crismon, folder as RainbowFolder); }
        ...
        private static void TagCrismonCallback(object folder)
        { AssignTag(FolderTagName.Crismon, folder as RainbowFolder); }
